...
class Tank:
    ...
    def forvard(self):
        self.__vx = 0
        self.__vy = -1
        self.__canvas.itemconfig(self.__id, image= skin.get('up'))

    def backward(self):
        self.__vx = 0
        self.__vy = 1
        self.__canvas.itemconfig(self.__id, image= skin.get('down'))

    def left(self):
        self.__vx = -1
        self.__vy = 0
        self.__canvas.itemconfig(self.__id, image=skin.get('left'))

    def right(self):
        self.__vx = 1
        self.__vy = 0
        self.__canvas.itemconfig(self.__id, image= skin.get('right'))
    def stop(self):
        self.__vx = 0
        self.__vy = 0
    ...
    def __create(self):
        self.__id = self.__canvas.create_image(self.__x, self.__y, image=skin.get('up'), anchor=NW)
