...
#intersects
    ...
    def intersects_2(self, other2):
        ...
        if self.bottom < other2.top:
            return False
        return True
    def intersects_3(self, other3):
        if self.left > other3.right:
            return False
        if self.right < other3.left:
            return False
        if self.top > other3.bottom:
            return False
        if self.bottom < other3.top:
            return False
        return True
    def __str__(self):
